        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              const SizedBox(width: 15.0),
              getPlantCard('assets/ora-pro-nobis.png', 'FOLHAGEM', 'Ora-pro-nóbis'),
              const SizedBox(width: 15.0),
              getPlantCard('assets/grama-esmeralda.png', 'GRAMADO', 'Grama Zóisia'),
              const SizedBox(width: 15.0),
              getPlantCard('assets/pessegueiro.png', 'FRUTIFERA', 'Pessegueiro'),
              const SizedBox(width: 15.0),
